...
namespace sc
{
	SC_CONSTRUCT_PARENT_EXCEPTION(GeneralRuntimeException, LzmaGeneralException, "Failed to make LZMA operation");

#pragma region Compress
	SC_CONSTRUCT_PARENT_EXCEPTION(LzmaGeneralException, LzmaDecompressException, "Failed to decompress LZMA data");
...
#pragma region Decompress
	...
	SC_CONSTRUCT_PARENT_EXCEPTION(LzmaGeneralException, LzmaCompressException, "Failed to compress LZMA data");
