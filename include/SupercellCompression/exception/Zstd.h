...
namespace sc
{
	SC_CONSTRUCT_SIMPLE_EXCEPTION(ZstdGeneralException, "Failed to make ZSTD operation");

#pragma region Compress
	SC_CONSTRUCT_CHILD_EXCEPTION(ZstdGeneralException, ZstdDecompressException, "Failed to decompress ZSTD data");
...
#pragma region Decompress
	...
	SC_CONSTRUCT_CHILD_EXCEPTION(ZstdGeneralException, ZstdCompressException, "Failed to compress ZSTD data");
