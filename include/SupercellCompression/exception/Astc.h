...
namespace sc
{
	SC_CONSTRUCT_SIMPLE_EXCEPTION(AstcGeneralException, "Failed to make ASTC operation");

#pragma region Compress
	SC_CONSTRUCT_CHILD_EXCEPTION(AstcGeneralException, AstcDecompressException, "Failed to decompress ASTC data");
...
#pragma region Decompress
	...
	SC_CONSTRUCT_CHILD_EXCEPTION(AstcGeneralException, AstcCompressException, "Failed to compress ASTC data");
