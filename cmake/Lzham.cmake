...
target_include_directories("lzhamlib" PRIVATE
    "${lzham_codec_SOURCE_DIR}/include"
    "${LZHAM_DEC_SOURCE_DIR}"
    "${LZHAM_CMP_SOURCE_DIR}"
)

target_compile_definitions("lzhamlib" PRIVATE
    $<${SC_RELEASE}:NDEBUG>
    $<${SC_DEBUG}:_DEBUG>
)
...
if($<NOT:${SC_X64}>)
    target_compile_options("lzhamlib" PRIVATE
        $<${SC_GNU}: -m32>
    )
endif()
...
# TODO: Make .patch for LZHAM to make it work on MacOS